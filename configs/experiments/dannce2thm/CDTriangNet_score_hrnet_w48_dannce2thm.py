...
load_from = "work_dirs/pretrain_2d/dannce/hrnet/epoch_100.pth"
...
data = dict(
    ...
    train=dict(
        ...
        target_data=dict(
            type='THM3dDatasetMview',
            ann_file=f"{thm_root}/annotations/anno_20221229_train.json",
            ann_3d_file=f"{thm_root}/annotations/anno_20221229_joints_3d.json",
            cam_file=f"{thm_root}/calibration_adjusted.json",
    ...
    val=dict(
        ...
        target_data=dict(
            type='THM3dDatasetMview',
            ann_file=f"{thm_root}/annotations/anno_20221229_test.json",
            ann_3d_file=f"{thm_root}/annotations/anno_20221229_joints_3d.json",
            cam_file=f"{thm_root}/calibration_adjusted.json",
            img_prefix=f'{thm_root}/',
            data_cfg=thmouse_data_cfg,
